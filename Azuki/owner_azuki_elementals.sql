...
WITH base AS (
    ...
    WHERE nft_address = '0xb6a37b5d14d502c3ab0ae6f3a0e058bc9517786e'
),
holders AS (
    SELECT 
    ...
    FROM base
    WHERE rn = 1  -- Only the most recent owners
...
SELECT 
    ...
    ROUND((ownership_distribution.holder_count::FLOAT / total_holders.total) * 100, 2) AS percentage
FROM ownership_distribution, total_holders
