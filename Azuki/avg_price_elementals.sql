-- avg sale price azuki elementals
...
select
  ...
  CASE
    when avg_sale_price <= 950 then 'low sale price range'
    when avg_sale_price > 950
    and avg_sale_price <= 1036 then 'mid sale price range'
    when avg_sale_price > 1036
    and avg_sale_price <= 32623 then 'high sale price range'
