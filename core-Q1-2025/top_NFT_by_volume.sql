...
FROM core.nft.ez_nft_transfers nft
JOIN core.core.fact_transactions tr 
on transaction = tr.tx_hash
...
nft_name,
round(sum(nft_price),1) as "NFT_VOLUME🟠",
FROM nft_table
where tx_date >= '2025-01-01'
group by 1,2
order by 3 DESC
limit 15
